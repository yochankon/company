    ...
    <div className="page">
      <section className="page-hero">
        ...
        <p className="hero-lead">
          1997년 설립 이후, 상하수도설비공사와 석공사 분야에서 꾸준히 현장을 지켜온 전문건설업체입니다.
        </p>
      </section>
      ...
      <section className="section">
        ...
        <div className="greeting-card">
          ...
          <p>
            중요할 요(要), 빛날 찬(燦). {company.name}이라는 이름에는 '중요한 곳에서 빛난다'는 뜻이
            담겨 있습니다. 저희는 이 이름처럼, 눈에 잘 띄지 않는 배관 속과 땅 밑에서도 그 진가가
            드러나는 공사를 해왔습니다. 상하수도설비공사와 석공사는 화려하게 드러나는 일은 아니지만,
            건물의 기초와 생활의 근간을 이루는 만큼 정말 중요한 곳에서 그 가치가 빛나는 공사입니다.
          </p>
          <p>
          ...
          <p>
            앞으로도 정직한 시공과 책임감 있는 사후 관리로, 정말 중요한 순간에 고객님과 함께 빛나는
            {company.name}이 되겠습니다. 감사합니다.
          </p>
